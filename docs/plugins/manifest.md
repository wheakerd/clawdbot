...
| `supervisorGuidance`                 | No       | `object`                     | Versioned declaration identifying a plugin config property containing display-only external-supervisor instructions. Configure guidance on exactly one enabled plugin. See [Supervisor guidance](/plugins/manifest/surfaces#supervisor-guidance).                                                                                                                                                |
