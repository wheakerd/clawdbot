...
- [`supervisorGuidance`](/plugins/manifest/surfaces#supervisor-guidance)
...
| `supervisorGuidance`                 | No       | `object`                     | Versioned declaration identifying a plugin config property containing display-only external-supervisor instructions. Select its owner with `plugins.slots.supervisorGuidance`. See [Supervisor guidance](/plugins/manifest/surfaces#supervisor-guidance).                                                                                                                                        |
