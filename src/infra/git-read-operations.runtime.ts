...
import { captureSessionDiffBaseline, loadCheckoutDiff } from "../sessions/session-diff.runtime.js";
...
export async function executeGitReadOperation(
  ...
  switch (operation.type) {
    ...
    case "checkout.diff":
      return await loadCheckoutDiff(operation.input);
    case "checkout.baseline":
      return await captureSessionDiffBaseline(operation.input);
